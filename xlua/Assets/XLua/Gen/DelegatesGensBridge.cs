...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp4(int p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp5(int p0, int p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp13(int p0, int p1, out int p2, out int p3, out int p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp14(ref int p0, ref int p1, out int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<int, int, int>(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(System.Func<int, int, int>))
			{
			    return new System.Func<int, int, int>(__Gen_Delegate_Imp5);
			}
		    ...
		    if (type == typeof(CSharpCallFunction_mutireturn.delAddingMutilReturn))
			{
			    return new CSharpCallFunction_mutireturn.delAddingMutilReturn(__Gen_Delegate_Imp13);
			}
		
		    if (type == typeof(CSharpCallFunction_mutireturn.delAddingMutilReturnRef))
			{
			    return new CSharpCallFunction_mutireturn.delAddingMutilReturnRef(__Gen_Delegate_Imp14);
			}
