...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(CSharpCallTable_2.IGameLanguage), CSharpCallTable_2IGameLanguageBridge.__Create);
            
            translator.AddInterfaceBridgeCreator(typeof(CSharpCallTable_3.IGameUser), CSharpCallTable_3IGameUserBridge.__Create);
